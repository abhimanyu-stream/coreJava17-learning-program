# Spring Bean Lifecycle with IOC
...
1. **Created**
2. **Initialized**
3. **Used inside Spring container**
4. **Destroyed**
...
Spring executes: `postProcessBeforeInitialization()`
...
Spring runs: `postProcessAfterInitialization()`
...
For every bean, Spring creates: **BeanDefinition**
...
**Example:** UserService BeanDefinition (NOT actual object yet)

### 4. BeanFactory Stores Bean Definitions

**DefaultListableBeanFactory** stores all BeanDefinitions.

**Internally:** `Map<String, BeanDefinition>`
...
Spring executes: `postProcessAfterInitialization()`
